...
class MovieProvider extends ChangeNotifier {
  ...
  // Future<void> loadcategoryMovies() async{
  //   final res= await http.get(Uri.parse(" https://yts.mx/api/v2/list_movies.json?genre={category}?movie_id=' + id"));
  //    print(jsonDecode(res.body)['data']['movies']);
  //   List<MovieModel> tempMovies = [];
  ...
  //     tempMovies.add(MovieModel.fromJson(movie));
  //   }
  //    _categories= tempMovies.cast<String>();
  //   notifyListeners();
  // }
